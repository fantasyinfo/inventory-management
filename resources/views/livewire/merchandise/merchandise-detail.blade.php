...
<div>
    ...
    <div class="flex items-center space-x-3">
        <svg class="w-6 h-6 text-indigo-500 dark:text-indigo-400" fill="none" stroke="currentColor" 
            ...
            <path stroke-linecap="round" stroke-linejoin="round" 
                  d="M16 14a4 4 0 1 0-8 0 4 4 0 0 0 8 0z"></path>
        </svg>
    ...
    <div class="flex items-center space-x-3">
        <svg class="w-6 h-6 text-yellow-500 dark:text-yellow-400" fill="none" stroke="currentColor" 
             stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" 
                  d="M12 20h.01M12 20c4 0 7-3 7-7 0-1.93-.78-3.68-2.05-4.95M12 20c-4 0-7-3-7-7 0-1.93.78-3.68-2.05-4.95M12 4c1.104 0 2-.896 2-2s-.896 2-2 2-2 .896-2 2z"></path>
        </svg>
        <p class="text-gray-700 dark:text-gray-300 text-lg">
    ...
    <div class="flex items-center space-x-3">
        ...
        <p class="text-gray-700 dark:text-gray-300 text-lg">
            ...
            <div class="flex items-center space-x-3">
                ...
                <p class="text-gray-700 dark:text-gray-300 text-lg">Date of Purchase: {{ date('F j, Y', strtotime($merchandise['date_of_purchase'])) }}</p>
            </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <p class="text-gray-700 dark:text-gray-300 text-lg">Last Updated: {{ date('F j, Y', strtotime($merchandise['updated_at'])) }}</p>
            </div>
        </div>
        ...
        <div class="mt-6 flex justify-between">
            ...
            <a href="{{route('merchandise')}}" wire:navigate class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg transition">
                Back
            </a>
        </div>
    </div>
